...
then
    ...
    docker run --restart=unless-stopped -d --name=idanode_testnet -dit -p 4001:3001 -p 27017:27017 scrypta:idanode -testnet
    ...
    docker run --restart=unless-stopped -d --name=idanode -dit -p 3001:3001 -p 27017:27017 scrypta:idanode
